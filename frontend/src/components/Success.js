      ...
      try {
        ...
        if (foundPurchase) {
          purchaseData = {
            ...
            finalAmount: parseFloat(foundPurchase.finalAmount || foundPurchase.amount || 10),
            originalAmount: parseFloat(foundPurchase.originalAmount || foundPurchase.amount || foundPurchase.finalAmount || 10),
                ...
                if (sessionData.success && sessionData.session?.metadata) {
                  ...
                  if (metadata.squareNumber && contactEmailFromStripe) {
                    purchaseData = {
                      ...
                      finalAmount: sessionData.session.amount_total ? parseFloat((sessionData.session.amount_total / 100).toFixed(2)) : parseFloat(foundPurchase?.finalAmount || foundPurchase?.amount || 10),
                      originalAmount: sessionData.session.amount_total ? parseFloat((sessionData.session.amount_total / 100).toFixed(2)) : parseFloat(foundPurchase?.originalAmount || foundPurchase?.amount || 10),
                      discountAmount: 0,
                      promoCode: null,
            ...
            try {
              ...
              if (!purchaseSnapshot.empty) {
                ...
                purchaseData = {
                  ...
                  finalAmount: parseFloat(firestoreData.finalAmount || firestoreData.amount || 10),
                  originalAmount: parseFloat(firestoreData.originalAmount || firestoreData.amount || 10),
